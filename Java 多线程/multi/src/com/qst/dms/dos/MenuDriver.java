...
public class MenuDriver {
	...
	public static final String WELCOME_LINE = "欢迎进入日志物流信息数据系统";
	public static final String CODE_LINE_1 = "* 1.数据采集  2.数据匹配 *";
	public static final String CODE_LINE_2 = "* 3.数据记录  4.数据显示 *";
	public static final String CODE_LINE_3 = "* 5.数据发送  0.退出应用 *";
	...
	private static void printMenuBlock(){
		System.out.println(SPLITE_LINE);
		System.out.println(WELCOME_LINE);
		System.out.println(CODE_LINE_1);
		System.out.println(CODE_LINE_2);
		System.out.println(CODE_LINE_3);
		System.out.println(SPLITE_LINE);
	}
}
